...
#    Updated: 2020/07/12 02:30:06 by alopez-g         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		=	${SRCS_DIR}ft_memset.c ${SRCS_DIR}ft_bzero.c ${SRCS_DIR}ft_memcpy.c ${SRCS_DIR}ft_memccpy.c ${SRCS_DIR}ft_memmove.c ${SRCS_DIR}ft_memchr.c \
				...
				${SRCS_DIR}ft_putchar_fd.c ${SRCS_DIR}ft_putstr_fd.c ${SRCS_DIR}ft_putendl_fd.c ${SRCS_DIR}ft_putnbr_fd.c ${SRCS_DIR}ft_itoab.c
