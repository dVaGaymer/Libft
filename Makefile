...
#    Updated: 2020/08/23 13:17:00 by dvagaymer        ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

LIBFT_INC	=	${LIBFT_DIR}includes/
SRCS_DIR	=	${LIBFT_DIR}srcs/
SRCS		=	${SRCS_DIR}ft_memset.c ${SRCS_DIR}ft_stronly.c ${SRCS_DIR}ft_bzero.c ${SRCS_DIR}ft_memcpy.c ${SRCS_DIR}ft_memccpy.c ${SRCS_DIR}ft_memmove.c ${SRCS_DIR}ft_memchr.c \
				...
				${SRCS_DIR}ft_strnstr.c ${SRCS_DIR}ft_strncmp.c ${SRCS_DIR}ft_atoi.c ${SRCS_DIR}ft_atof.c  ${SRCS_DIR}ft_isalpha.c ${SRCS_DIR}ft_isdigit.c ${SRCS_DIR}ft_isalnum.c \
				${SRCS_DIR}ft_isascii.c ${SRCS_DIR}ft_isspace.c ${SRCS_DIR}ft_isprint.c ${SRCS_DIR}ft_toupper.c ${SRCS_DIR}ft_tolower.c ${SRCS_DIR}ft_calloc.c ${SRCS_DIR}ft_strdup.c\
				...
				${SRCS_DIR}ft_lstnew_bonus.c ${SRCS_DIR}ft_lstadd_front_bonus.c ${SRCS_DIR}ft_lstsize_bonus.c ${SRCS_DIR}ft_lstlast_bonus.c \
